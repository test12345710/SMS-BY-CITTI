...
/**
 * Handles polymorphic (subtype) serialization/deserialization with Gson.
 */
	...
	public <R> TypeAdapter<R> create(Gson gson, TypeToken<R> type) {
		...
		return new TypeAdapter<>() {
			...
			public void write(JsonWriter out, R value) throws IOException {
				...
				if (label == null) throw new JsonParseException("Unknown subtype: " + srcType);
			...
			public R read(JsonReader in) throws IOException {
				...
				if (labelJson == null) throw new JsonParseException("Missing type field '" + typeFieldName + "'");
